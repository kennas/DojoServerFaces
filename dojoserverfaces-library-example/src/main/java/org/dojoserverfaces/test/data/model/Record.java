...
public class Record {
	...
	private Float[] savedAmountValues = new Float[] {new Float(1), new Float(10), new Float(100), new Float(1000)};
	...
	private java.sql.Timestamp sqlTimestamp = new java.sql.Timestamp(birthDate.getTime());
	private List<Options> options;
	private String[] optionKeys = {"option1","option2", "option3", "option4", "option5", "option6"};
