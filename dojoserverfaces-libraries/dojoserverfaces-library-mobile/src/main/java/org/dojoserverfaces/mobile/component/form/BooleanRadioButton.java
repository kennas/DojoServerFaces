 ...
 * 
 */
@EditableValueHolder(dojoType = "dojox.mobile.RadioButton", elementType = HtmlElementType.INPUT_RADIO, requiredCss = { "dojox/mobile/themes/{theme}/RadioButton.css" })
public class BooleanRadioButton extends InputBase {
    /**
