...
@ManagedBean(name = "booleanRadioButtonBean")
@RequestScoped
public class BooleanRadioButtonBean {
    private WidgetValues widgetValues = new BooleanRadioButtonValues();
    ...
    @DataValidator(widgetValues = BooleanRadioButtonValues.class)
    private Boolean widgetBeanValidation;

    public BooleanRadioButtonBean() {
    ...
    private class BooleanRadioButtonValues extends WidgetValues {

        public BooleanRadioButtonValues() {
