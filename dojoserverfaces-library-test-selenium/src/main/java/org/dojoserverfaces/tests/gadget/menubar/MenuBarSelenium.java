...
public class MenuBarSelenium extends SeleniumTestCase {
    ...
    public void setUp() throws Exception {
        ...
        if (selenium != null) {
            selenium
                    .open("http://localhost:8080/eclipse-jsfdojo-library-test-selenium/dojoserverfaces/gadget/menubar/index.jsf");
        }
    }
