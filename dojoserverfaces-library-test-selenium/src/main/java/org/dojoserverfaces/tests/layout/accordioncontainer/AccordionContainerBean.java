...
@ManagedBean(name = "accordionContainerBean")
@RequestScoped
public class AccordionContainerBean {
    private WidgetValues widgetValues = new AccordionContainerValues();
