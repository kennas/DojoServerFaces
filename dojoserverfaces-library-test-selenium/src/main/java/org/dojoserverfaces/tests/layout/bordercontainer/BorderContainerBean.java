...
@ManagedBean(name = "borderContainerBean")
@RequestScoped
public class BorderContainerBean {
    private WidgetValues widgetValues = new BorderContainerValues();
