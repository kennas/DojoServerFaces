...
@ManagedBean(name = "dynamicTextAreaBean")
@RequestScoped
public class DynamicTextAreaBean {
    private WidgetValues widgetValues = new DynamicTextAreaValues();
    ...
    @DataValidator(widgetValues = DynamicTextAreaValues.class)
    private String widgetBeanValidation;

    public DynamicTextAreaBean() {
