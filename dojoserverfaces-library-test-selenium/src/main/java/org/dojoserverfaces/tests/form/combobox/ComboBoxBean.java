...
@ManagedBean(name = "comboBoxBean")
@RequestScoped
public class ComboBoxBean {
    private WidgetValues widgetValues = new ComboBoxValues();

    private StringArrayData values = new StringArrayData(widgetValues
            .getValuesArray());
    ...
    @DataValidator(widgetValues = ComboBoxValues.class)
    ...
    public StringArrayData getValues() {
        return values;
    }

    public void setValues(StringArrayData values) {
        this.values = values;
    }
}