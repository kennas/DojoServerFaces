...
@ManagedBean(name = "horizontalSliderBean")
@RequestScoped
public class HorizontalSliderBean {
    private WidgetValues widgetValues = new HorizontalSliderValues();
    ...
    @DataValidator(widgetValues = HorizontalSliderValues.class)
    private String widgetBeanValidation;

    public HorizontalSliderBean() {
