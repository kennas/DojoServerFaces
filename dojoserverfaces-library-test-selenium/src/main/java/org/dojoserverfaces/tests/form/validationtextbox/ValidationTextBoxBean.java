...
@ManagedBean(name = "validationTextBoxBean")
@RequestScoped
public class ValidationTextBoxBean {
    private WidgetValues widgetValues = new ValidationTextBoxValues();
    ...
    @DataValidator(widgetValues = ValidationTextBoxValues.class)
    private String widgetBeanValidation;

    public ValidationTextBoxBean() {
