...
@ManagedBean(name = "numberTextBoxBean")
@RequestScoped
public class NumberTextBoxBean {
    private WidgetValues widgetValues = new NumberTextBoxValues();
    ...
    @DataValidator(widgetValues = NumberTextBoxValues.class)
    private Integer widgetBeanValidation;

    public NumberTextBoxBean() {
