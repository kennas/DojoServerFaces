...
@ManagedBean(name = "filteringSelectBean")
@RequestScoped
public class FilteringSelectBean {
    private WidgetValues widgetValues = new FilteringSelectValues();
    ...
    @DataValidator(widgetValues = FilteringSelectValues.class)
    private String widgetBeanValidation;

    public FilteringSelectBean() {
