...
public class HorizontalSliderSelenium extends LayoutComponentSelenium {
    ...
    public void setUp() throws Exception {
        ...
        if (selenium != null) {
            ...
            selenium
                    .open("http://localhost:8080/eclipse-dojoserverfaces-library-test-selenium/dojoserverfaces/form/horizontalslider/index.jsf");
        }
    }
