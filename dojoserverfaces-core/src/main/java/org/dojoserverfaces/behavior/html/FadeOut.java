...
/**
 * This behavior will allow you to fade out an element
 */
@Behavior
public class FadeOut extends BehaviorBase {
    ...
    public String getScript(ClientBehaviorContext behaviorContext) {
        ...
        if (null != target) {
            ...
            for (String token : tokens) {
                ...
                script.append("dojo.fadeOut({node:");
    ...
    /**
     * broadcast a topic after faded out.
     */
    @Attribute
